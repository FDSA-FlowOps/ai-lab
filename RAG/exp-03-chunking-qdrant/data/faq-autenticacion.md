...
## Buenas practicas
- Activar autenticacion multifactor para cuentas administrativas.
- Rotar contrasena cada 90 dias en perfiles de alto privilegio.
- Evitar compartir credenciales entre miembros del equipo.

## Escalamiento
Escalar a seguridad cuando exista evidencia de acceso no autorizado.
Escalar a infraestructura si hay incremento anormal de errores 401 o 403 en menos de 10 minutos.
